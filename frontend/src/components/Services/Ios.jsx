  ...
  <div className="bg-black min-h-screen py-10 px-3 flex flex-col items-center">
    ...
    <div
      className={`
        ...
        mb-12 transition-transform duration-300 hover:scale-105 hover:shadow-red-800/30
      `}
    >
      {/* Image Side */}
      ...
      <div className="md:w-1/2 p-6 lg:p-10 xl:p-14 flex flex-col justify-center h-full">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 transition-colors group-hover:text-red-400">
        ...
        <ul className="text-red-400 space-y-1 text-sm md:text-base list-disc ml-4">
    ...
    <div
      className={`
        bg-gradient-to-tr from-red-900 via-zinc-900 to-purple-900
      ...
      `}
    >
      <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold text-red-400 mb-3">
