...
const SampleBlog = () => {
  ...
  <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      <div className="max-w-xl w-full">
        <div
          className="group bg-gradient-to-br from-white to-gray-100 rounded-2xl shadow-2xl backdrop-blur-xl overflow-hidden border border-gray-200 
        ...
        >
          ...
          <div className="p-7 md:p-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">The Promise of WebGPU: A New Era in Web Graphics</h2>
